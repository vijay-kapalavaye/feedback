...
export function FeedbackForm() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-4 py-10 sm:px-6 sm:py-12 md:px-8 md:py-16">
        <main className="flex w-full max-w-[min(100%,680px)] flex-col">
          <header className="mb-6 text-center sm:mb-8">
            <h1 className="text-balance text-2xl font-bold tracking-tight text-slate-800 sm:text-3xl md:text-4xl">
          ...
          <div className="mt-6 sm:mt-8">
            ...
            <motion.textarea
              ...
              className="w-full resize-y rounded-xl border border-slate-200 bg-white/90 px-3 py-3 text-sm text-slate-800 shadow-inner shadow-slate-100 placeholder:text-slate-400 outline-none ring-sky-300/0 transition focus:border-sky-300 focus:ring-4 focus:ring-sky-200/60 sm:text-base"
              whileFocus={{
                boxShadow:
                  "0 0 0 4px rgba(125, 211, 252, 0.45), 0 12px 32px rgba(15, 23, 42, 0.06)",
              }}
            />
          </div>
          ...
          <motion.button
            ...
            disabled={loading}
            className="relative mt-6 flex w-full items-center justify-center gap-2 overflow-hidden rounded-full bg-gradient-to-r from-violet-500 via-fuchsia-400 to-amber-400 px-6 py-3.5 text-base font-semibold text-white shadow-md shadow-violet-300/50 disabled:cursor-not-allowed disabled:opacity-80 sm:mt-8 sm:py-4 sm:text-lg"
            whileHover={
              loading
                ? undefined
                : {
